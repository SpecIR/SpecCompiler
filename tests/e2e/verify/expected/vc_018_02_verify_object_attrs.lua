-- Test oracle for VC-VERIFY-001: Object Attribute Violation Detection
-- Verifies object attribute errors are triggered for object attribute violations
--
...
return function(actual_doc, helpers)
    ...
    if helpers.expect_errors then
        ...
        -- Note: Invalid enum values may report as invalid_cast (cast failure) or invalid_enum
        local expected_codes = {
            ["missing_required"] = "Missing required attribute",
            ["invalid_cast"] = "Cast failure (includes invalid enum)"
        }
        ...
        if #test_errors > 0 then
            ...
            return false, "Object attribute test failed:\n  Missing: " ..
