-- Test oracle for VC-INT-005: View Rendering
-- Verifies TOC and LOF views render live at EMIT as BulletLists in the output.
...
return function(actual_doc, helpers)
    ...
    if #actual_doc.blocks < 3 then
        ...
        return false, "View rendering validation failed:\n  - " .. table.concat(errors, "\n  - ")
    end

    -- Find BulletList elements (rendered views)
    local bullet_lists = {}
    ...
    if #bullet_lists < 1 then
        err("Expected at least 1 BulletList (rendered view), got 0")
    end
