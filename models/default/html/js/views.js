...
(function() {
  ...
  var VIEW_DEFS = {
    traceability: {
      ...
      description: 'All resolved relationships between spec objects',
      sql: [
        'SELECT',
        ...
        'WHERE r.target_object_id IS NOT NULL',
    ...
    relations_summary: {
      ...
      description: 'Relation counts by type per specification',
      sql: [
        'SELECT',
        '  r.specification_ref AS spec_id,',
        '  r.type_ref AS relation_type,',
        '  COUNT(*) AS total,',
        '  COUNT(r.target_object_id) + COUNT(r.target_float_id) AS resolved,',
        '  COUNT(*) - COUNT(r.target_object_id) - COUNT(r.target_float_id) AS unresolved',
        'FROM spec_relations r',
        'GROUP BY r.specification_ref, r.type_ref',
        'ORDER BY spec_id, total DESC, relation_type'
      ].join(' '),
      linkColumns: []
    },
    unresolved: {
